# Generated by Django 5.0.4 on 2024-04-28 03:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('RecipeCategory', models.CharField(max_length=100, null=True)),
                ('DifficultyLevel', models.CharField(max_length=100, null=True)),
                ('Tags', models.CharField(choices=[('vegetarian', 'Vegetarian'), ('nonvegetarian', 'Non-Vegetarian')], max_length=100, null=True)),
