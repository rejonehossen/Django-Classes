...
@login_required
def profilechef(request):
    currentuser=request.user
    profile=chefprofile.objects.filter(myuser=currentuser)
    # commonprofile=customuser.objects.all()
    myDict={
        'profile':profile,
        # commonprofile:cpmm
    }
    return render(request,'profilechef.html',myDict)